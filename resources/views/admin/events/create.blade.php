        ...
        <div class="col-lg-8">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="event_type"
                                    ...
                                    <option value="coffee_date"      {{ old('event_type') === 'coffee_date'      ? 'selected' : '' }}>Coffee Date</option>
                                    <option value="bootcamp"         {{ old('event_type') === 'bootcamp'         ? 'selected' : '' }}>Bootcamp</option>
                                    <option value="workshop"         {{ old('event_type') === 'workshop'         ? 'selected' : '' }}>Workshop</option>
                                    <option value="showcase"         {{ old('event_type') === 'showcase'         ? 'selected' : '' }}>Showcase</option>
                                    <option value="networking_event" {{ old('event_type') === 'networking_event' ? 'selected' : '' }}>Networking Event</option>
                                </select>
                                @error('event_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="price_field" style="{{ old('is_free') ? 'display:none;' : '' }}">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="form-group mb-0">
                        ...
                        <small class="form-text text-muted">JPG, PNG or WebP. Max 2MB.</small>
                    </div>
                </div>
            </div>
